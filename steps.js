...
Given(/^I goto the singup page$/, async () => {
...
Given(/^I am sing out from website$/, async () => {
    await pages['myAccount'].clickSingOut()
});

Given(/^Sing in page should be displayed$/, async () => {
    await pages['signup'].verifySingInPage()
});

Given(/^I am sing in to website$/, async (table) => {
