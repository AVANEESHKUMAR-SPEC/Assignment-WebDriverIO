Feature: Signup to My Store, Do login and Buy a Product
    ...
    Scenario: As a user, I can singup to website
        Given I am on the home page
        And I goto the singup page
    ...
    Scenario: As a user, I can sing out
        When I am sing out from website
        Then Sing in page should be displayed

    Scenario: As a user, I can sing in
        When I am sing in to website
            | Password |
            | vin@123  |
        Then I should be logged-in
            | Fname | Lname |
